...
interpolated_trajectory_x1 = lagrange(mediciones_df.index, mediciones_df["x1"])
interpolated_trajectory_x2 = lagrange(mediciones_df.index, mediciones_df["x2"])
...
plt.title('Trajectoria del tractor con Lagrange')
plt.xlabel('X')
plt.ylabel('Y')

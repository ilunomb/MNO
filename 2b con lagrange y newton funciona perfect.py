...
df_vehiculo1 = pd.read_csv("mnyo_mediciones.csv", sep=" ", header=None)
df_vehiculo2 = pd.read_csv("mnyo_mediciones2.csv", sep=" ", header=None)

# Convertir los datos a arrays de numpy
datos_vehiculo1 = df_vehiculo1.values
datos_vehiculo2 = df_vehiculo2.values

# Extraer coordenadas x1 y x2 de cada vehículo
x1_vehiculo1, x2_vehiculo1 = datos_vehiculo1[:, 0], datos_vehiculo1[:, 1]
x1_vehiculo2, x2_vehiculo2 = datos_vehiculo2[:, 0], datos_vehiculo2[:, 1]

# Interpolación de la trayectoria del segundo vehículo con Lagrange
polinomio_interpolado = lagrange(x1_vehiculo2, x2_vehiculo2)
